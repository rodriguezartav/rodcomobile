...
"app": function(exports, require, module) {(function() {
  ...
  Logins = (function() {
    ...
    Logins.prototype.login = function() {
      var query;
      query = 'email=' + this.email.val() + '&password=' + this.password.val() + '&token=' + this.token.val();
      $("#header img").show();
      return $.ajax({
  ...
  Quotes = (function() {
    ...
    Quotes.prototype.save_quotes = function(event) {
      ...
      if (client) {
        ...
        return this.txt_observation.val("");
      }
    };
    return Quotes;
  })();
  ...
  Opp = (function() {
    ...
    Opp.configure("Opp", "clientId", "clientName", "productId", "productName", "amount", "price", "discount", "stage", "observation");
